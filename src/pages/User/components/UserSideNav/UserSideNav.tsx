    ...
    <div>
      <div className='flex items-center border-b border-b-gray-200 py-4'>
        ...
        <div className='flex-grow pl-4'>
          <div className='mb-1 truncate font-semibold text-gray-600'>BaoDepTrai</div>
      ...
      <div className='mt-7'>
        <Link to={path.profile} className='flex items-center capitalize text-orange transition-colors'>
          <div className='flex items-center'>
            ...
            <span className='text-md ml-2 text-black'>Tài khoản của tôi</span>
          </div>
        </Link>
        <Link to={path.historyPurchase} className='my-3 flex items-center capitalize text-orange transition-colors'>
          <div className='flex items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
            ...
            <span className='text-md ml-2 text-black'>Đơn mua</span>
          </div>
        </Link>
        <Link to={path.changePassword} className='flex items-center capitalize text-orange transition-colors'>
          <div className='flex items-center'>
            ...
            <span className='text-md ml-2 text-black'>Đổi mật khẩu</span>
          </div>
        </Link>
      </div>
    </div>
