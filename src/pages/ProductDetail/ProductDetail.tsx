          ...
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='flex items-center'>
                  ...
                  <ProductRating
                    ...
                    activeClassnam='fill-orange text-orange h-4 w-4'
                    nonActievClassname='fill-gray-300 text-gray-300 h-4 w-4'
                  />
                </div>
              ...
              <div className='mt-8 flex items-center'>
                ...
                <button className='ml-4 h-12 min-w-[5rem] items-center justify-center rounded-sm bg-orange px-5 capitalize text-white shadow-sm outline-none hover:bg-orange/90'>
                  Mua ngay
                </button>
              </div>
            </div>
