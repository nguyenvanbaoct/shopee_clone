...
export default function Header() {
  ...
  return (
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2 text-xs text-white'>
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            className='flex cursor-pointer items-center  py-1 hover:text-white/70'
            renderPopover={
              <div className='relative rounded-sm border border-gray-200 bg-white pl-3 pr-28 shadow-md'>
                <div className='flex flex-col  py-2'>
                  <button className='py-2 text-left text-sm hover:text-orange'>Tiếng Việt</button>
                  <button className='py-2 text-left text-sm hover:text-orange'>English</button>
                </div>
              </div>
            }
          >
              ...
              renderPopover={
                <div className='rounded-sm border-gray-200 bg-white shadow-md'>
                  ...
                  <button
                    ...
                    className='block w-full px-4 py-3 text-left text-sm hover:text-cyan-400'
                  >
                    Đăng Xuất
                  </button>
                </div>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          <Link to={path.home} className='col-span-2 justify-self-start'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              ...
              />
              <button className='flex-shrink-0 rounded-sm bg-orange px-5 py-2 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
              ...
              renderPopover={
                <div className='max-w-[400px] rounded-sm border-gray-200 bg-white text-sm shadow-md '>
                  {purchasesInCart ? (
                    ...
                    <div className='flex h-[330px] w-[300px] flex-col items-center justify-center p-2'>
