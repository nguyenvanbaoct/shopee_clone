  ...
  return (
    <div className='flex justify-end text-sm'>
        ...
        renderPopover={
          <div className='relative rounded-sm border border-gray-200 bg-white pl-3 pr-28 shadow-md'>
            <div className='flex flex-col  py-2'>
              <button onClick={() => changeLanguage('vi')} className='py-2 text-left text-sm hover:text-orange'>
                Tiếng Việt
              </button>
              <button onClick={() => changeLanguage('en')} className='py-2 text-left text-sm hover:text-orange'>
                English
              </button>
            </div>
          </div>
      ...
      >
        ...
        <span className='mx-1 text-xs'>{currentLanguage}</span>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          fill='none'
          viewBox='0 0 24 24'
